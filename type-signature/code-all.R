...
call_arguments_data <- tibble(call_exit_id = numeric(0), fun_name = str(0), is_call_user = numeric(0), call_stack_depth = numeric(0), is_user_call_with_pipe_operator = numeric(0), caller = str(0), line_number = str(0), param_index = numeric(0), is_param_missing = numeric(1), name_of_param = str(0), type_of_argument = str(0), class_of_argument = str(0), address_of_argument = character(0), package_details = str(0))
